...
EvalContext fields:
  ...
  outputs  list[str]   the sampled outputs for this version
  config   dict        the full spec config
  runtime  dict        captured runtime metadata
  samples  list[dict]  raw samples (output, tokens, latency_ms)
"""
import re
